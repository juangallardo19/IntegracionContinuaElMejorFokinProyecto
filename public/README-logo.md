...
Por favor, coloca el archivo **logo.png** en esta carpeta (`public/`).
...
- **Uso**:
  ...
  - Logo en la página de inicio - HomePage (128x128 px)
...
### Nota Importante:
El Navbar usa un icono SVG de libro, NO el logo.png.
